    ...
    internal class VehicleFactory {
        public static Vehicle CreateVehicle(eSupportVehicles i_VehicleType ,string i_LicensePlate, string i_Model, List<Wheel> i_Wheels, eMotorLicenseType? i_LicenseType, int? i_EngineVolume, eCarColors? i_Color, int? i_NumberOfDoors, bool? i_IsCarryingDangerousMaterials, float? i_CargoVolume) {
            return i_VehicleType switch 
            {
                ...
                eSupportVehicles.Car => new Car(new CreateCarInput(new CreateVehicleInput(i_Model, i_LicensePlate, i_Wheels, new FuelEngine(45f, eFuelType.Octan95)), (eCarColors)i_Color!, (int)i_NumberOfDoors!)),
                eSupportVehicles.ElectricCar => new Car(new CreateCarInput(new CreateVehicleInput(i_Model, i_LicensePlate, i_Wheels, new ElectricEngine(3.5f)), (eCarColors)i_Color!, (int)i_NumberOfDoors!)),
                eSupportVehicles.Truck => new Truck(new CreateTruckInput(new CreateCarInput(new CreateVehicleInput(i_Model, i_LicensePlate, i_Wheels, new FuelEngine(120f,eFuelType.Solar)), (eCarColors)i_Color!, (int)i_NumberOfDoors!), (bool)i_IsCarryingDangerousMaterials!, (float)i_CargoVolume!)),
